...
axis1.AB_a = -0.75;                 %Actuator base anchor parallel offset (m)
axis1.AB_r = -0.2;                  %Actuator base anchor perpendicular offset (m)
axis1.AT_a = -0.075;                %Actuator tip anchor parallel offset (m)
axis1.AT_r = -0.2;                  %Actuator tip anchor perpendicular offset (m)
